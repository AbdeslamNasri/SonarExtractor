...
public final class Unmarshallers {
  ...
  static {
    ...
    unmarshallers.put(Projects.class, new ProjectsUnmarshaller());
    unmarshallers.put(ProjectAnalyses.class, new ProjectAnalysesUnmarshaller());
    unmarshallers.put(Component.class, new ComponentUnmarshaller());
  }
